...
UPDATE people SET name = 'Anthony Starke' WHERE name = 'Anthony Starkes';
SELECT name FROM people WHERE name = 'Hamish Whyte';
DELETE FROM movies WHERE title = 'Batman Begins';
INSERT INTO people(name) VALUES ('Louise Camlin');
DELETE FROM people WHERE name = 'Craig Morton';
INSERT INTO movies(title, year, show_time) VALUES ('Captain Marvel', 2019, '20:50');
